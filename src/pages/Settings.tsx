    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>配置应用的基本参数</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          <div className="space-y-4">
            <div>
              <Label htmlFor="api-url">API 服务器地址</Label>
            ...
            {saved && (
              <div className="p-3 bg-green-900/20 border border-green-700/50 rounded text-green-400 text-sm flex items-center gap-2">
                <span>✓ 设置已保存</span>
              </div>
            )}

            <div className="p-3 bg-blue-900/20 border border-blue-700/50 rounded text-blue-300 text-sm flex items-center gap-2">
          ...
          <div className="border-t pt-6">
            <h3 className="font-semibold mb-4">当前配置信息</h3>
